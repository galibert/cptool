...
wl = {
   ...
   "AM_RAM", "AM_RAMBANK", "AM_RAM_READ", "AM_RAM_WRITE", "AM_RAM_DEVREAD", "AM_RAM_DEVWRITE", "AM_WRITEONLY",
   "AM_NOP", "AM_WRITENOP", "AM_UNMAP", "AM_READUNMAP", "AM_WRITE_PORT", "AM_READWRITE_PORT"
}
...
rl = {
   ...
   "AM_NOP", "AM_READNOP", "AM_READONLY", "AM_UNMAP", "AM_READUNMAP", "AM_READ_PORT", "AM_READWRITE_PORT"
}
